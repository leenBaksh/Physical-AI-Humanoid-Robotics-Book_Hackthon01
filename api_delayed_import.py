...
Fixed version that avoids path modification conflicts.
"""
...
# Import agent components after FastAPI app is defined to avoid conflicts
def initialize_agent_components():
    """Initialize agent components after FastAPI app is set up"""
    ...
    return BookRetriever, BookAgent, retrieve_qdrant_chunks_impl
...
async def startup_event():
    ...
    try:
        ...
        BookRetriever, BookAgent, retrieve_qdrant_chunks_impl = initialize_agent_components()
